    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        if (data.user) {
            ...
            if (profile?.role !== 'admin' && profile?.role !== 'tutor') {
                ...
                setError('Akses ditolak. Halaman ini hanya untuk Admin dan Tutor.');
                setIsLoading(false);
                return;
            }
        }
        ...
        <div className="min-h-screen flex items-center justify-center px-4 bg-background">
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-foreground/35 text-xs">Privcey Edu — Admin & Tutor</p>
                </div>
                ...
                <div className="rounded-2xl bg-foreground/3 border border-foreground/6 p-6">
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        <div className="space-y-1.5">
                            <label className="block text-xs font-medium text-foreground/50">Email</label>
                ...
                <p className="text-center text-foreground/20 text-[11px] mt-4">
                    Siswa? <a href="/auth/login" className="text-blue-500/60 hover:text-blue-500 transition-colors">Login dengan Google di sini</a>
                </p>
            </motion.div>
        </div>
    );
