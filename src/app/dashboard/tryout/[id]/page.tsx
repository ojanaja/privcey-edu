...
export default function TryOutDetailPage() {
    ...
    const { setExam, isStarted } = useExamStore();
    ...
    if (!tryout) {
        return (
            <GlassCard hoverable={false} className="text-center py-16">
                <p className="text-foreground/50">Try Out tidak ditemukan</p>
                    ...
                    <GlassCard hoverable={false} padding="lg">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                            <div className="text-center p-3 rounded-xl bg-foreground/[0.02] border border-foreground/[0.04]">
                                ...
                                <p className="text-sm font-medium text-foreground">{tryout.duration_minutes} menit</p>
                                <p className="text-[10px] text-foreground/30">Durasi</p>
                            </div>
                            <div className="text-center p-3 rounded-xl bg-foreground/[0.02] border border-foreground/[0.04]">
                        ...
                        >
                            {previousAttempt ? 'Kerjakan Ulang' : 'Mulai Ujian'}
                        </Button>
                ...
                <div>
                    {previousAttempt ? (
                        <GlassCard hoverable={false} padding="md" className="text-center">
                            <h3 className="text-sm font-medium text-foreground/50 mb-4">Hasil Sebelumnya</h3>
                            ...
                            {previousAttempt.finished_at && (
                                <p className="text-[10px] text-foreground/20 mt-4">
                                    Selesai: {formatDateTime(previousAttempt.finished_at)}
                                </p>
                            )}
                        ...
                        <GlassCard hoverable={false} padding="md" className="text-center">
                            <div className="py-8 text-foreground/20">
                                ...
                                <p className="text-sm">Belum pernah mengerjakan</p>
                                <p className="text-xs mt-1">
                                    Klik &quot;Mulai Ujian&quot; untuk memulai
                                </p>
                            </div>
                        </GlassCard>
                    )}
